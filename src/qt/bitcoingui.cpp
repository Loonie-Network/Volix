                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Volix Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Volix address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and volix: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Volix Core"), this);
    aboutAction->setStatusTip(tr("Show information about Volix Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Volix"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Volix addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Volix addresses"));
    ...
    openAction->setStatusTip(tr("Open a Volix: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Volix Core help message to get a list with possible Volix command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Volix Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Volix network", "", count));
}
...
{
    QString strTitle = tr("Volix Core"); // default title
