...
/** Utility functions used by the Volix Qt UI.
 */
namespace GUIUtil
{
...
// Render Volix addresses in monospace font
...
// Parse "volix:" URI into recipient object, return true on successful parsing
