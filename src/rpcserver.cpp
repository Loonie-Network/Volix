...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Volix features */
        {"volix", "masternode", &masternode, true, true, false},
        {"volix", "listmasternodes", &listmasternodes, true, true, false},
        {"volix", "getmasternodecount", &getmasternodecount, true, true, false},
        {"volix", "masternodeconnect", &masternodeconnect, true, true, false},
        {"volix", "masternodecurrent", &masternodecurrent, true, true, false},
        {"volix", "masternodedebug", &masternodedebug, true, true, false},
        {"volix", "startmasternode", &startmasternode, true, true, false},
        {"volix", "createmasternodekey", &createmasternodekey, true, true, false},
        {"volix", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"volix", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"volix", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"volix", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"volix", "getmasternodescores", &getmasternodescores, true, true, false},
        {"volix", "mnbudget", &mnbudget, true, true, false},
        {"volix", "preparebudget", &preparebudget, true, true, false},
        {"volix", "submitbudget", &submitbudget, true, true, false},
        {"volix", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"volix", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"volix", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"volix", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"volix", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"volix", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"volix", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"volix", "checkbudgets", &checkbudgets, true, true, false},
        {"volix", "mnsync", &mnsync, true, true, false},
        {"volix", "spork", &spork, true, true, false},
        {"volix", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"volix", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use volixd, or the -server option to volix-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> volix-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5761/\n";
}
