...
This mechanism has been integrated into Bitcore-Node-Volix which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Volix-Project/insight-api-volix#web-socket-api](https://github.com/Volix-Project/insight-api-volix#web-socket-api) 
* API: [https://github.com/Volix-Project/insight-api-volix#swifttx-transactions](https://github.com/Volix-Project/insight-api-volix#swifttx-transactions) 
...
By default, the Volix Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Volix Core daemon:
