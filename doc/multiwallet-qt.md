...
In order to support loading of multiple wallets in volix-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is volix.cpp.
...
Changes to volix.cpp
----------------------
volix.cpp is the entry point into volix-qt, and as such, will require some minor modifications to provide hooks for
